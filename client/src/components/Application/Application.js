        ...
        <Modal size="lg" open={open} toggle={this.toggle}>
          ...
          <ModalBody>
            <form>
                ...
                <div class="form-group">
                    <label for="reason">Detalle el motivo por el cual desea participar en este proyecto</label>
                    <textarea class="form-control" id="reason" placeholder="Escriba aquí" required/>
                    <small id="help" class="form-text text-muted">Las respuesta no puede exceder los 200 caracteres</small>
                </div>
